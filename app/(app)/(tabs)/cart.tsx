...
import { updateCart, deleteCart } from "@/services/redux/cartSlice";
...
const CartItem = memo(
  ({
    ...
    const imageUri = { uri: `${IMG_URL + image}` };
                ...
                <View>
                  ...
                  <View style={{ flexDirection: "row" }}>
                    ...
                    <Pressable
                      ...
                      onPress={() => onRemove(id, item.id, title)}
                    >
                      <MaterialIcons
                        name="delete-forever"
                        size={20}
          ...
          <View style={styles.container}>
            <View style={{ flexDirection: "row", gap: 15 }}>
              ...
              <View>
                ...
                <View style={{ flexDirection: "row" }}>
                  ...
                  <Pressable
                    style={{ flexDirection: "row" }}
                    onPress={() => onRemove(id, items[0].id, title)}
                  >
                    <MaterialIcons
                      name="delete-forever"
                      size={20}
            ...
            <View style={{ alignItems: "center" }}>
              <Pressable
                style={styles.spinner}
                onPress={() =>
                  changeCart(id, items[0].id, items[0].quantity + 1)
                }
              >
                <Text style={styles.spinnerText}>+</Text>
              </Pressable>
    ...
    return (
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        <LottieView
          ...
          source={require("@/assets/images/cart_empty.json")}
        />
